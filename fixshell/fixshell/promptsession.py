...
class FixHistory(History):
    ...
    @staticmethod
    def default() -> FixHistory:
        # this path existed until 3.5.0
        old_path = pathlib.Path.home() / ".fixshell_history"
        path = pathlib.Path.home() / ".fix" / "shell_history"
