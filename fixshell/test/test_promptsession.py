...
from fixshell.promptsession import (
...
known_commands = [
    ...
    CommandInfo(
        ...
        args={
            ...
            "edit": [
                ArgInfo(None, expects_value=True, help_text="<config_id> e.g. fix.core"),
            ],
            "update": [
                ArgInfo(
                    None,
...
def test_parse_command_info() -> None:
    ...
    app = {"args": [], "help": "", "info": "Tag Validator app for Fix.", "name": "tagvalidator", "source": True}
    template = {
        "args": [
            {
                "can_occur_multiple_times": False,
...
def test_complete_option() -> None:
    ...
    assert complete("configs show ", n, True) == {"<config_id> e.g. fix.core"}
