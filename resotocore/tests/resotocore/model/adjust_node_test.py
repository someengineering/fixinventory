...
from resotocore.model.adjust_node import DirectAdjuster, NoAdjust
from resotocore.types import Json
from resotocore.util import utc_str, value_in_path
...
def test_adjust_expired() -> None:
    ...
    def expect_expires(reported: Json, expires: Optional[Union[str, Pattern[Any]]]) -> None:
        ...
        if expires is None:
            ...
            assert expires.fullmatch(value_in_path(result, ["metadata", "expires"]))  # type: ignore
