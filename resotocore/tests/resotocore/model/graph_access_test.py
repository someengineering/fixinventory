...
def test_edges(graph_access: GraphAccess) -> None:
    ...
    assert list(graph_access.not_visited_edges(EdgeType.default)) == [
        ("1", "3"),
        ("2", "4"),
        ("3", "4"),
    ]
    assert list(graph_access.not_visited_edges(EdgeType.delete)) == [
        ("1", "2"),
        ("1", "3"),
        ("1", "4"),
    ]
