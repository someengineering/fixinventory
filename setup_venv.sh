...
install_plugins() {
    local collector_plugins=(aws aws_k8s digitalocean digitalocean_k8s dockerhub example_collector gcp github k8s onelogin onprem posthog random scarf slack vsphere)
