...
install_plugins() {
    local collector_plugins=(aws gcp slack onelogin k8s onprem github dockerhub random example_collector cleanup_expired cleanup_aws_alarms cleanup_aws_loadbalancers cleanup_aws_vpcs cleanup_untagged cleanup_volumes protector tagvalidator vsphere digitalocean digitalocean_k8s)
