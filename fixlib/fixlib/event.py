...
class EventType(Enum):
    ...
    START_COLLECT: None
    COLLECT_BEGIN: fixlib.graph.Graph
    COLLECT_FINISH: fixlib.graph.Graph
    CLEANUP_PLAN: fixlib.graph.Graph
    CLEANUP_BEGIN: fixlib.graph.Graph
    CLEANUP_FINISH: fixlib.graph.Graph
    PROCESS_BEGIN: fixlib.graph.Graph
    PROCESS_FINISH: fixlib.graph.Graph
    GENERATE_METRICS: fixlib.graph.Graph
    """
