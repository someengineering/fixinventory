...
class BaseResource(ABC):
    ...
    reference_kinds: ClassVar[ModelReference] = {}
    metadata: ClassVar[Dict[str, Any]] = {"icon": "resource.svg", "group": "misc"}
...
class BaseQuota(PhantomBaseResource):
    metadata: ClassVar[Dict[str, Any]] = {"icon": "quota.svg", "group": "control"}
...
class BaseType(BaseQuota):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "type.svg", "group": "control"}
...
class BaseInstanceQuota(BaseQuota):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "instance.svg", "group": "compute"}
...
class BaseInstanceType(BaseType):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "instance_type.svg", "group": "compute"}
    instance_type: Optional[str] = None
...
class BaseCloud(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "cloud.svg", "group": "control"}
...
class BaseAccount(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "account.svg", "group": "control"}
...
class BaseRegion(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "region.svg", "group": "control"}
...
class BaseZone(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "zone.svg", "group": "control"}
...
class BaseNetworkShare(BaseResource, ABC):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "network_share.svg", "group": "storage"}
    share_size: int = 0
    share_type: str = ""
...
class BaseSnapshot(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "snapshot.svg", "group": "storage"}
    snapshot_status: str = ""
...
class GraphRoot(PhantomBaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "graph_root.svg", "group": "control"}
...
class BaseBucket(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "bucket.svg", "group": "storage"}


@define(eq=False, slots=False)
class BaseServerlessFunction(BaseResource):
    kind: ClassVar[str] = "serverless_function"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "function.svg", "group": "compute"}


@define(eq=False, slots=False)
class BaseKeyPair(BaseResource):
    kind: ClassVar[str] = "keypair"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "keypair.svg", "group": "access_control"}
    fingerprint: str = ""
...
class BaseBucketQuota(BaseQuota):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "quota.svg", "group": "storage"}


@define(eq=False, slots=False)
class BaseNetwork(BaseResource):
    kind: ClassVar[str] = "network"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "network.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseNetworkQuota(BaseQuota):
    kind: ClassVar[str] = "network_quota"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "quota.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseDatabase(BaseResource):
    kind: ClassVar[str] = "database"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "database.svg", "group": "database"}
    db_type: str = ""
    db_status: str = ""
...
class BaseLoadBalancer(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "load_balancer.svg", "group": "networking"}
    lb_type: str = ""
...
class BaseSubnet(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "subnet.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseGateway(BaseResource):
    kind: ClassVar[str] = "gateway"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "gateway.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseTunnel(BaseResource):
    kind: ClassVar[str] = "tunnel"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "tunnel.svg", "group": "networking"}
...
class BaseSecurityGroup(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "security_group.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseRoutingTable(BaseResource):
    kind: ClassVar[str] = "routing_table"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "routing_table.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseNetworkAcl(BaseResource):
    kind: ClassVar[str] = "network_acl"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "acl.svg", "group": "networking"}


@define(eq=False, slots=False)
class BasePeeringConnection(BaseResource):
    kind: ClassVar[str] = "peering_connection"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "connection.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseEndpoint(BaseResource):
    kind: ClassVar[str] = "endpoint"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "endpoint.svg", "group": "networking"}


@define(eq=False, slots=False)
class BaseNetworkInterface(BaseResource):
    kind: ClassVar[str] = "network_interface"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "network_interface.svg", "group": "networking"}
...
class BaseUser(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "user.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BaseGroup(BaseResource):
    kind: ClassVar[str] = "group"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "group.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BasePolicy(BaseResource):
    kind: ClassVar[str] = "policy"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "policy.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BaseRole(BaseResource):
    kind: ClassVar[str] = "role"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "role.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BaseInstanceProfile(BaseResource):
    kind: ClassVar[str] = "instance_profile"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "instance_profile.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BaseAccessKey(BaseResource):
    kind: ClassVar[str] = "access_key"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "key.svg", "group": "access_control"}
...
class BaseCertificate(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "certificate.svg", "group": "access_control"}
...
class BaseCertificateQuota(BaseQuota):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "quota.svg", "group": "access_control"}


@define(eq=False, slots=False)
class BaseStack(BaseResource):
    kind: ClassVar[str] = "stack"
    metadata: ClassVar[Dict[str, Any]] = {"icon": "stack.svg", "group": "control"}
    stack_status: str = ""
...
class BaseAutoScalingGroup(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "autoscaling_group.svg", "group": "compute"}
    min_size: int = -1
    max_size: int = -1
...
class BaseIPAddress(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "network_address.svg", "group": "networking"}
    ip_address: str = ""
...
class BaseHealthCheck(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "health_check.svg", "group": "compute"}
...
class BaseDNSZone(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "dns.svg", "group": "networking"}
...
class BaseDNSRecord(BaseResource):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"icon": "dns_record.svg", "group": "networking"}
