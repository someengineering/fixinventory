...
from fixcore.message_bus import MessageBus, CoreMessage, Message
from fixcore.ids import SubscriberId
from fixcore.task import TaskHandler
from fixcore.task.task_description import PerformAction, Workflow
...
def wait_and_start(
    ...
    async def wait_for_subscriber() -> None:
        subscriber_id = SubscriberId(f"fixcore.wait_for_actor_{uuid_str()}")
