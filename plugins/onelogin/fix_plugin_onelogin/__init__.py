...
from fixlib.baseresources import BaseAccount, BaseRegion, BaseUser
...
class OneLoginResource:
    ...
    kind_display: ClassVar[str] = "OneLogin Resource"
    kind_description: ClassVar[str] = "A OneLogin Resource."
