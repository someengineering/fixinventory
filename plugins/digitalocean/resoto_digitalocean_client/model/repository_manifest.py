...
def lazy_import():
    ...
    globals()['RepositoryBlob'] = RepositoryBlob


class RepositoryManifest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tags': ([str],),  # noqa: E501
            'blobs': ([RepositoryBlob],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RepositoryManifest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            repository (str): The name of the repository.. [optional]  # noqa: E501
            digest (str): The manifest digest. [optional]  # noqa: E501
            compressed_size_bytes (int): The compressed size of the manifest in bytes.. [optional]  # noqa: E501
            size_bytes (int): The uncompressed size of the manifest in bytes (this size is calculated asynchronously so it may not be immediately available).. [optional]  # noqa: E501
            updated_at (datetime): The time the manifest was last updated.. [optional]  # noqa: E501
            tags ([str]): All tags associated with this manifest. [optional]  # noqa: E501
            blobs ([RepositoryBlob]): All blobs associated with this manifest. [optional]  # noqa: E501
        """
