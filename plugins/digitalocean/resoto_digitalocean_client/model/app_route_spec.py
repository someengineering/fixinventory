...
class AppRouteSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'path': (str,),  # noqa: E501
            'preserve_path_prefix': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        'path': 'path',  # noqa: E501
        'preserve_path_prefix': 'preserve_path_prefix',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            preserve_path_prefix (bool): An optional flag to preserve the path that is forwarded to the backend service. By default, the HTTP request path will be trimmed from the left when forwarded to the component. For example, a component with `path=/api` will have requests to `/api/list` trimmed to `/list`. If this value is `true`, the path will remain `/api/list`.. [optional]  # noqa: E501
        """
