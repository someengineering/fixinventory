...
class AwsServiceQuota(AwsResource, BaseQuota):
    ...
    metadata: ClassVar[Dict[str, Any]] = {"provider_link_tpl": "https://{region_id}.console.aws.amazon.com/servicequotas/home/services/{source[ServiceCode]}/quotas/{id}", "arn_tpl": "arn:{partition}:service-quotas:{region}:{account}:quotas/{id}"}  # fmt: skip
    kind_description: ClassVar[str] = (
