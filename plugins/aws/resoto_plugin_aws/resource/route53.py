...
class AwsRoute53ZoneConfig:
    ...
    kind_description: ClassVar[str] = "Route53 Zone Config is a service provided by Amazon Web Services that allows users to configure DNS settings for their domain names in the cloud."
...
class AwsRoute53LinkedService:
    ...
    kind_description: ClassVar[str] = "Route 53 Linked Service is a feature in AWS Route 53 that allows you to link your domain name to other AWS services, such as an S3 bucket or CloudFront distribution."
...
class AwsRoute53Zone(AwsResource, BaseDNSZone):
    ...
    kind_description: ClassVar[str] = "Route 53 is a scalable domain name system (DNS) web service designed to provide highly reliable and cost-effective domain registration, DNS routing, and health checking of resources within the AWS cloud."
...
class AwsRoute53GeoLocation:
    ...
    kind_description: ClassVar[str] = "Route53 Geo Location is a feature of AWS Route53 DNS service that allows you to route traffic based on the geographic location of your users, providing low latency and improved user experience."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class AwsRoute53AliasTarget:
    ...
    kind_description: ClassVar[str] = "AWS Route 53 Alias Target is a feature of Amazon Route 53, a scalable domain name system web service that translates domain names to IP addresses. Alias Target allows you to route traffic to other AWS resources such as Amazon S3 buckets, CloudFront distributions, and Elastic Load Balancers."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class AwsRoute53CidrRoutingConfig:
    ...
    kind_description: ClassVar[str] = "CIDR Routing Config is a feature in AWS Route 53 that allows you to route traffic based on CIDR blocks, enabling more granular control over how your DNS queries are resolved."
...
class AwsRoute53ResourceRecord(AwsResource, BaseDNSRecord):
    ...
    kind_description: ClassVar[str] = "Route 53 Resource Records are domain name system (DNS) records used by AWS Route 53 to route traffic to AWS resources or to external resources."
    reference_kinds: ClassVar[ModelReference] = {
        "successors": {
            "default": [],
            "delete": [],
...
class AwsRoute53ResourceRecordSet(AwsResource, BaseDNSRecordSet):
    ...
    kind_description: ClassVar[str] = "Route 53 Resource Record Sets are DNS records that map domain names to IP addresses or other DNS resources, allowing users to manage domain name resolution in the Amazon Route 53 service."
    reference_kinds: ClassVar[ModelReference] = {
        "successors": {
