...
class AwsDynamoDbGlobalSecondaryIndexDescription:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "provisioned_throughput": S("ProvisionedThroughput") >> Bend(AwsDynamoDbProvisionedThroughputDescription.mapping),
        "index_size_bytes": S("IndexSizeBytes"),
        "item_count": S("ItemCount"),
        "index_arn": S("IndexArn")
    }
...
class AwsDynamoDbReplicaDescription:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "provisioned_throughput_override": S("ProvisionedThroughputOverride","ReadCapacityUnits"),
        "global_secondary_indexes": S("GlobalSecondaryIndexes", default=[]) >> ForallBend(AwsDynamoDbReplicaGlobalSecondaryIndexDescription.mapping),
...
class AwsDynamoDbTable(AwsResource):
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "arn": S("TableArn"),
        "dynamodb_attribute_definitions": S("AttributeDefinitions", default=[]) >> ForallBend(AwsDynamoDbAttributeDefinition.mapping),
        ...
        "dynamodb_provisioned_throughput": S("ProvisionedThroughput") >> Bend(AwsDynamoDbProvisionedThroughputDescription.mapping),
        ...
        "dynamodb_local_secondary_indexes": S("LocalSecondaryIndexes", default=[]) >> ForallBend(AwsDynamoDbLocalSecondaryIndexDescription.mapping),
        "dynamodb_global_secondary_indexes": S("GlobalSecondaryIndexes", default=[]) >> ForallBend(AwsDynamoDbGlobalSecondaryIndexDescription.mapping),
...
class AwsDynamoDbGlobalTable(AwsResource):
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "dynamodb_replication_group": S("ReplicationGroup", default=[]) >> ForallBend(AwsDynamoDbReplicaDescription.mapping),
