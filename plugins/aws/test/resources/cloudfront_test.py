...
from resoto_plugin_aws.resource.cloudfront import AwsCloudFrontDistribution, AwsCloudFrontFunction, AwsCloudFrontInvalidation, AwsCloudFrontPublicKey, AwsCloudFrontRealtimeLogConfig
...
def test_realtime_log_configs() -> None:
    ...
    assert len(builder.resources_of(AwsCloudFrontRealtimeLogConfig)) == 1
