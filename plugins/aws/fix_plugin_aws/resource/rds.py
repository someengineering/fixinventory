...
class AwsRdsInstance(RdsTaggable, AwsResource, BaseDatabase):
    ...
    aws_metadata: ClassVar[Dict[str, Any]] = {"arn_tpl": "arn:{partition}:rds:{region}:{account}:db:{name}"}  # fmt: skip
...
class AwsRdsCluster(RdsTaggable, AwsResource, BaseDatabase):
    ...
    aws_metadata: ClassVar[Dict[str, Any]] = {"arn_tpl": "arn:{partition}:rds:{region}:{account}:cluster/{name}"}  # fmt: skip
...
class AwsRdsSnapshot(RdsTaggable, AwsResource, BaseSnapshot):
    ...
    aws_metadata: ClassVar[Dict[str, Any]] = {"arn_tpl": "arn:{partition}:rds:{region}:{account}:snapshot:{id}/{name}"}  # fmt: skip
...
class AwsRdsClusterSnapshot(AwsResource):
    ...
    aws_metadata: ClassVar[Dict[str, Any]] = {"arn_tpl": "arn:{partition}:rds:{region}:{account}:snapshot/{name}"}  # fmt: skip
