...
@define(eq=False, slots=False)
class AwsBedrockProvisionedModelThroughput(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_provisioned_model_throughput"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock", "list-provisioned-model-throughputs", "provisionedModelSummaries")
    mapping: ClassVar[Dict[str, Bender]] = {
...
@define(eq=False, slots=False)
class AwsBedrockGuardrail(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_guardrail"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock", "list-guardrails", "guardrails")
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("guardrailId"),
        "name": S("name"),
        "ctime": S("createdAt"),
        ...
        "sensitive_information_policy": S("sensitiveInformationPolicy") >> Bend(AwsBedrockGuardrailSensitiveInformationPolicy.mapping),
        "contextual_grounding_policy": S("contextualGroundingPolicy") >> Bend(AwsBedrockGuardrailContextualGroundingPolicy.mapping),
    ...
    name: Optional[str] = field(default=None, metadata={"description": "The name of the guardrail."})  # fmt: skip
...
@define(eq=False, slots=False)
class AwsBedrockModelCustomizationJob(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_model_customization_job"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock", "list-model-customization-jobs", "modelCustomizationJobSummaries")
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("jobArn"),
        "name": S("jobName"),
        "arn": S("jobArn"),
...
class AwsBedrockEvaluationDataset:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "name": S("name"),
        "dataset_location": S("datasetLocation","s3Uri")
    }
...
class AwsBedrockAutomatedEvaluationConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "dataset_metric_configs": S("datasetMetricConfigs", default=[]) >> ForallBend(AwsBedrockEvaluationDatasetMetricConfig.mapping)
    }
...
@define(eq=False, slots=False)
class AwsBedrockEvaluationJob(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_evaluation_job"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock", "list-evaluation-jobs", "jobSummaries")
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("jobArn"),
        "name": S("jobName"),
        "arn": S("jobArn"),
        ...
        "inference_config": S("inferenceConfig") >> Bend(AwsBedrockEvaluationInferenceConfig.mapping),
        "output_data_config": S("outputDataConfig","s3Uri"),
        "creation_time": S("creationTime"),
        "last_modified_time": S("lastModifiedTime"),
    ...
    inference_config: Optional[AwsBedrockEvaluationInferenceConfig] = field(default=None, metadata={"description": "Details about the models you specified in your model evaluation job."})  # fmt: skip
...
class AwsBedrockPromptOverrideConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "prompt_configurations": S("promptConfigurations", default=[]) >> ForallBend(AwsBedrockPromptConfiguration.mapping)
    }
...
@define(eq=False, slots=False)
class AwsBedrockAgent(AwsResource):
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "guardrail_configuration": S("agent", "guardrailConfiguration") >> Bend(AwsBedrockGuardrailConfiguration.mapping),
        ...
        "prompt_override_configuration": S("agent", "promptOverrideConfiguration") >> Bend(AwsBedrockPromptOverrideConfiguration.mapping),
        "recommended_actions": S("agent", "recommendedActions", default=[]),
    ...
    recommended_actions: Optional[List[str]] = field(factory=list, metadata={"description": "Contains recommended actions to take for the agent-related API that you invoked to succeed."})  # fmt: skip
...
@define(eq=False, slots=False)
class AwsBedrockAgentVersion(AwsResource):
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "guardrail_configuration": S("agentVersion", "guardrailConfiguration") >> Bend(AwsBedrockGuardrailConfiguration.mapping),
        ...
        "prompt_override_configuration": S("agentVersion", "promptOverrideConfiguration") >> Bend(AwsBedrockPromptOverrideConfiguration.mapping),
        "recommended_actions": S("agentVersion", "recommendedActions", default=[]),
    ...
    prompt_override_configuration: Optional[AwsBedrockPromptOverrideConfiguration] = field(default=None, metadata={"description": "Contains configurations to override prompt templates in different parts of an agent sequence. For more information, see Advanced prompts."})  # fmt: skip
    recommended_actions: Optional[List[str]] = field(factory=list, metadata={"description": "A list of recommended actions to take for the failed API operation on the version to succeed."})  # fmt: skip
...
class AwsBedrockVectorKnowledgeBaseConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "embedding_model_configuration": S("embeddingModelConfiguration") >> Bend(AwsBedrockEmbeddingModelConfiguration.mapping)
    }
...
class AwsBedrockKnowledgeBaseConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "type": S("type"),
        "vector_knowledge_base_configuration": S("vectorKnowledgeBaseConfiguration") >> Bend(AwsBedrockVectorKnowledgeBaseConfiguration.mapping)
    }
...
class AwsBedrockStorageConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "mongo_db_atlas_configuration": S("mongoDbAtlasConfiguration") >> Bend(AwsBedrockMongoDbAtlasConfiguration.mapping),
        "opensearch_serverless_configuration": S("opensearchServerlessConfiguration") >> Bend(AwsBedrockOpenSearchServerlessConfiguration.mapping),
        ...
        "redis_enterprise_cloud_configuration": S("redisEnterpriseCloudConfiguration") >> Bend(AwsBedrockRedisEnterpriseCloudConfiguration.mapping),
        "type": S("type")
    }
...
@define(eq=False, slots=False)
class AwsBedrockAgentKnowledgeBase(AwsResource):
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "knowledge_base_configuration": S("knowledgeBase", "knowledgeBaseConfiguration") >> Bend(AwsBedrockKnowledgeBaseConfiguration.mapping),
        "knowledge_base_id": S("knowledgeBase", "knowledgeBaseId"),
        "role_arn": S("knowledgeBase", "roleArn"),
        "status": S("knowledgeBase", "status"),
        "storage_configuration": S("knowledgeBase", "storageConfiguration") >> Bend(AwsBedrockStorageConfiguration.mapping),
...
@define(eq=False, slots=False)
class AwsBedrockAgentPrompt(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_agent_prompt"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock-agent", "list-prompts", "promptSummaries")
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("id"),
        "name": S("name"),
        "ctime": S("createdAt"),
        ...
        "description": S("description"),
        "updated_at": S("updatedAt"),
        "variants": S("variants", default=[]) >> ForallBend(AwsBedrockPromptVariant.mapping),
        "version": S("version")
    }
    ...
    variants: Optional[List[AwsBedrockPromptVariant]] = field(factory=list, metadata={"description": "A list of objects, each containing details about a variant of the prompt."})  # fmt: skip
...
class AwsBedrockFlowDataConnectionConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "source_output": S("sourceOutput"),
        "target_input": S("targetInput")
    }
...
class AwsBedrockLexFlowNodeConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "bot_alias_arn": S("botAliasArn"),
        "locale_id": S("localeId")
    }
...
class AwsBedrockRetrievalFlowNodeConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "service_configuration": S("serviceConfiguration") >> Bend(AwsBedrockRetrievalFlowNodeServiceConfiguration.mapping)
    }
...
class AwsBedrockStorageFlowNodeConfiguration:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "service_configuration": S("serviceConfiguration") >> Bend(AwsBedrockStorageFlowNodeServiceConfiguration.mapping)
    }
...
@define(eq=False, slots=False)
class AwsBedrockAgentFlow(AwsResource):
    kind: ClassVar[str] = "aws_bedrock_agent_flow"
    api_spec: ClassVar[AwsApiSpec] = AwsApiSpec("bedrock-agent", "list-flows", "flowSummaries")
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("id"),
        "name": S("name"),
        "ctime": S("createdAt"),
...
@define(eq=False, slots=False)
class AwsBedrockAgentFlowVersion(AwsResource):
