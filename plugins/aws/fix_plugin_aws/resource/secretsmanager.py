...
class AwsSecretsManagerSecret(HasResourcePolicy, AwsResource):
    ...
    last_rotated_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The most recent date and time that the Secrets Manager rotation process was successfully completed. This value is null if the secret hasn't ever rotated."})  # fmt: skip
    last_changed_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The last date and time that this secret was modified in any way."})  # fmt: skip
    ...
    next_rotation_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The next rotation is scheduled to occur on or before this date. If the secret isn't configured for rotation, Secrets Manager returns null."})  # fmt: skip
    ...
    created_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The date and time when a secret was created."})  # fmt: skip
