...
class AwsSSMInstance(AwsResource):
    ...
    registration_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The date the server or VM was registered with Amazon Web Services as a managed node."})  # fmt: skip
