...
class AwsBackupPlan(BackupResourceTaggable, AwsResource):
    ...
    last_execution_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The last time a job to back up resources was run with this rule. A date and time, in Unix format and Coordinated Universal Time (UTC). The value of LastExecutionDate is accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM."})  # fmt: skip
...
class AwsBackupLegalHold(BackupResourceTaggable, AwsResource):
    ...
    creation_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "This is the time in number format when legal hold was created."})  # fmt: skip
    cancellation_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "This is the time in number format when legal hold was cancelled."})  # fmt: skip
...
class AwsBackupRestoreJob(AwsResource):
    ...
    recovery_point_creation_date: Optional[datetime] = field(default=None, metadata={"ignore_history": True, "description": "The date on which a recovery point was created."})  # fmt: skip
