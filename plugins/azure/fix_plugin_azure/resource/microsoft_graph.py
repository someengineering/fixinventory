...
class MicrosoftGraphServiceProvisioningError:
    ...
    created_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'The date and time at which the error occurred.'})  # fmt: skip
...
class MicrosoftGraphLicenseAssignmentState:
    ...
    last_updated_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'The timestamp when the state of the license assignment was last updated.'})  # fmt: skip
...
class MicrosoftGraphVerifiedPublisher:
    ...
    added_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'The timestamp when the verified publisher was first added or most recently updated.'})  # fmt: skip
...
class MicrosoftGraphUser(MicrosoftGraphEntity, BaseUser):
    ...
    external_user_state_change_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'Shows the timestamp for the latest change to the externalUserState property. Supports $filter (eq, ne, not , in).'})  # fmt: skip
    ...
    last_password_change_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'When this Microsoft Entra user last changed their password or when their password was created, whichever date the latest action was performed. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only. Returned only on $select.'})  # fmt: skip
...
class MicrosoftGraphGroup(MicrosoftGraphEntity, BaseGroup):
    ...
    created_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'Timestamp of when the group was created. The value can t be modified and is automatically populated when the group is created. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned by default. Read-only.'})  # fmt: skip
    ...
    on_premises_last_sync_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'Indicates the last time at which the group was synced with the on-premises directory.The Timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned by default. Read-only. Supports $filter (eq, ne, not, ge, le, in).'})  # fmt: skip
    ...
    renewed_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'Timestamp of when the group was last renewed. This cannot be modified directly and is only updated via the renew service action. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned by default. Supports $filter (eq, ne, not, ge, le, in). Read-only.'})  # fmt: skip
...
class MicrosoftGraphOrganization(MicrosoftGraphEntity, BaseAccount):
    ...
    created_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'Timestamp of when the organization was created. The value can t be modified and is automatically populated when the organization is created. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only.'})  # fmt: skip
    ...
    on_premises_last_password_sync_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'The last time a password sync request was received for the tenant.'})  # fmt: skip
    on_premises_last_sync_date_time: Optional[datetime] = field(default=None, metadata={"ignore_history": True, 'description': 'The time and date at which the tenant was last synced with the on-premises directory. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z.'})  # fmt: skip
