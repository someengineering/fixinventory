...
class GcpAIPlatformLocation(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations"], action="list", request_parameter={'name': 'projects/{project}/locations/{region}/{resource}/{resource_id}'}, request_parameter_in={"project", "resource_id", "region", "resource"}, response_path="locations", response_regional_sub_path=None)
...
class GcpAIPlatformExplanationMetadataInputMetadata:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "encoded_baselines": S("encodedBaselines", default=[]) >> ForallBend(GcpEncodedbaselines.mapping),
        "encoded_tensor_name": S("encodedTensorName"),
        "encoding": S("encoding"),
        "feature_value_domain": S("featureValueDomain", default={}) >> Bend(GcpAIPlatformExplanationMetadataInputMetadataFeatureValueDomain.mapping),
        ...
        "modality": S("modality"),
        "visualization": S("visualization", default={}) >> Bend(GcpAIPlatformExplanationMetadataInputMetadataVisualization.mapping)
    }
    ...
    feature_value_domain: Optional[GcpAIPlatformExplanationMetadataInputMetadataFeatureValueDomain] = field(default=None)
...
class GcpAIPlatformExplanationMetadata:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "inputs": S("inputs", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformExplanationMetadataInputMetadata.mapping)),
        "latent_space_source": S("latentSpaceSource"),
        "outputs": S("outputs", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformExplanationMetadataOutputMetadata.mapping))
    }
...
class GcpAIPlatformFeatureNoiseSigma:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "noise_sigma": S("noiseSigma", default=[]) >> ForallBend(GcpAIPlatformFeatureNoiseSigmaNoiseSigmaForFeature.mapping)
    }
...
class GcpAIPlatformExplanationParameters:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "integrated_gradients_attribution": S("integratedGradientsAttribution", default={}) >> Bend(GcpAIPlatformIntegratedGradientsAttribution.mapping),
...
class GcpAIPlatformBatchPredictionJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "batchPredictionJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="batchPredictionJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "dedicated_resources": S("dedicatedResources", default={}) >> Bend(GcpAIPlatformBatchDedicatedResources.mapping),
        ...
        "instance_config": S("instanceConfig", default={}) >> Bend(GcpAIPlatformBatchPredictionJobInstanceConfig.mapping),
        ...
        "state": S("state"),
        "unmanaged_container_model": S("unmanagedContainerModel", default={}) >> Bend(GcpAIPlatformUnmanagedContainerModel.mapping),
...
class GcpAIPlatformCustomJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "customJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="customJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformDataLabelingJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "dataLabelingJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="dataLabelingJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "label_fingerprint": S("labelFingerprint"),
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "active_learning_config": S("activeLearningConfig", default={}) >> Bend(GcpAIPlatformActiveLearningConfig.mapping),
...
class GcpAIPlatformDataset(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "datasets"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="datasets", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformDataItem(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_data_item"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "datasets", "dataItems"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="dataItems", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformUserActionReference:
    kind: ClassVar[str] = "gcp_ai_platform_user_action_reference"
    mapping: ClassVar[Dict[str, Bender]] = {
        "data_labeling_job": S("dataLabelingJob"),
        "method": S("method"),
        "operation": S("operation")
    }
    data_labeling_job: Optional[str] = field(default=None)
    method: Optional[str] = field(default=None)
    operation: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformAnnotation(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_annotation"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "datasets", "dataItems", "annotations"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="annotations", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "label_fingerprint": S("labelFingerprint"),
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "annotation_source": S("annotationSource", default={}) >> Bend(GcpAIPlatformUserActionReference.mapping),
        "create_time": S("createTime"),
        "etag": S("etag"),
        "payload": S("payload"),
        "payload_schema_uri": S("payloadSchemaUri"),
        "update_time": S("updateTime")
    }
    annotation_source: Optional[GcpAIPlatformUserActionReference] = field(default=None)
    create_time: Optional[datetime] = field(default=None)
    etag: Optional[str] = field(default=None)
    payload: Optional[Any] = field(default=None)
    payload_schema_uri: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformDatasetVersion(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_dataset_version"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "datasets", "datasetVersions"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="datasetVersions", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformDedicatedResources:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "autoscaling_metric_specs": S("autoscalingMetricSpecs", default=[]) >> ForallBend(GcpAIPlatformAutoscalingMetricSpec.mapping),
        "machine_spec": S("machineSpec", default={}) >> Bend(GcpAIPlatformMachineSpec.mapping),
        "max_replica_count": S("maxReplicaCount"),
...
@define(eq=False, slots=False)
class GcpAIPlatformDeploymentResourcePool(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_deployment_resource_pool"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "deploymentResourcePools"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="deploymentResourcePools", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformEndpoint(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "endpoints"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="endpoints", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "network": S("network"),
        "predict_request_response_logging_config": S("predictRequestResponseLoggingConfig", default={}) >> Bend(GcpAIPlatformPredictRequestResponseLoggingConfig.mapping),
        "private_service_connect_config": S("privateServiceConnectConfig", default={}) >> Bend(GcpAIPlatformPrivateServiceConnectConfig.mapping),
    ...
    network: Optional[str] = field(default=None)
    predict_request_response_logging_config: Optional[GcpAIPlatformPredictRequestResponseLoggingConfig] = field(default=None)
...
class GcpAIPlatformFeatureGroupBigQuery:
    kind: ClassVar[str] = "gcp_ai_platform_feature_group_big_query"
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpAIPlatformFeatureGroup(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featureGroups"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="featureGroups", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformFeature(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featureGroups", "features"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="features", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "etag": S("etag"),
        "monitoring_stats_anomalies": S("monitoringStatsAnomalies", default=[]) >> ForallBend(GcpAIPlatformFeatureMonitoringStatsAnomaly.mapping),
...
@define(eq=False, slots=False)
class GcpAIPlatformFeatureOnlineStoreBigtableAutoScaling:
    kind: ClassVar[str] = "gcp_ai_platform_feature_online_store_bigtable_auto_scaling"
    mapping: ClassVar[Dict[str, Bender]] = {
...
@define(eq=False, slots=False)
class GcpAIPlatformFeatureOnlineStoreBigtable:
    kind: ClassVar[str] = "gcp_ai_platform_feature_online_store_bigtable"
    mapping: ClassVar[Dict[str, Bender]] = {
        "auto_scaling": S("autoScaling", default={}) >> Bend(GcpAIPlatformFeatureOnlineStoreBigtableAutoScaling.mapping)
    }
    auto_scaling: Optional[GcpAIPlatformFeatureOnlineStoreBigtableAutoScaling] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureOnlineStoreDedicatedServingEndpoint:
    kind: ClassVar[str] = "gcp_ai_platform_feature_online_store_dedicated_serving_endpoint"
    mapping: ClassVar[Dict[str, Bender]] = {
        "private_service_connect_config": S("privateServiceConnectConfig", default={}) >> Bend(GcpAIPlatformPrivateServiceConnectConfig.mapping),
    ...
    service_attachment: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureOnlineStoreOptimized:
    kind: ClassVar[str] = "gcp_ai_platform_feature_online_store_optimized"
    mapping: ClassVar[Dict[str, Bender]] = {

    }

@define(eq=False, slots=False)
class GcpAIPlatformFeatureOnlineStore(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_feature_online_store"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featureOnlineStores"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="featureOnlineStores", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "label_fingerprint": S("labelFingerprint"),
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "bigtable": S("bigtable", default={}) >> Bend(GcpAIPlatformFeatureOnlineStoreBigtable.mapping),
        "create_time": S("createTime"),
        "dedicated_serving_endpoint": S("dedicatedServingEndpoint", default={}) >> Bend(GcpAIPlatformFeatureOnlineStoreDedicatedServingEndpoint.mapping),
        "encryption_spec": S("encryptionSpec","kmsKeyName"),
        "etag": S("etag"),
        "optimized": S("optimized", default={}) >> Bend(GcpAIPlatformFeatureOnlineStoreOptimized.mapping),
        "state": S("state"),
        "update_time": S("updateTime")
    }
    bigtable: Optional[GcpAIPlatformFeatureOnlineStoreBigtable] = field(default=None)
    create_time: Optional[datetime] = field(default=None)
    dedicated_serving_endpoint: Optional[GcpAIPlatformFeatureOnlineStoreDedicatedServingEndpoint] = field(default=None)
    encryption_spec: Optional[str] = field(default=None)
    etag: Optional[str] = field(default=None)
    optimized: Optional[GcpAIPlatformFeatureOnlineStoreOptimized] = field(default=None)
    state: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewBigQuerySource:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_big_query_source"
    mapping: ClassVar[Dict[str, Bender]] = {
        "entity_id_columns": S("entityIdColumns", default=[]),
        "uri": S("uri")
    }
...
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewFeatureRegistrySourceFeatureGroup:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_feature_registry_source_feature_group"
    mapping: ClassVar[Dict[str, Bender]] = {
        "feature_group_id": S("featureGroupId"),
        "feature_ids": S("featureIds", default=[])
    }
    feature_group_id: Optional[str] = field(default=None)
    feature_ids: Optional[List[str]] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewFeatureRegistrySource:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_feature_registry_source"
    mapping: ClassVar[Dict[str, Bender]] = {
        "feature_groups": S("featureGroups", default=[]) >> ForallBend(GcpAIPlatformFeatureViewFeatureRegistrySourceFeatureGroup.mapping),
        "project_number": S("projectNumber")
    }
    feature_groups: Optional[List[GcpAIPlatformFeatureViewFeatureRegistrySourceFeatureGroup]] = field(default=None)
    project_number: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewIndexConfigBruteForceConfig:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_index_config_brute_force_config"
    mapping: ClassVar[Dict[str, Bender]] = {

    }

@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewIndexConfig:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_index_config"
    mapping: ClassVar[Dict[str, Bender]] = {
        "brute_force_config": S("bruteForceConfig", default={}) >> Bend(GcpAIPlatformFeatureViewIndexConfigBruteForceConfig.mapping),
        "crowding_column": S("crowdingColumn"),
        "distance_measure_type": S("distanceMeasureType"),
        "embedding_column": S("embeddingColumn"),
        "embedding_dimension": S("embeddingDimension"),
        "filter_columns": S("filterColumns", default=[]),
        "tree_ah_config": S("treeAhConfig","leafNodeEmbeddingCount")
    }
    brute_force_config: Optional[GcpAIPlatformFeatureViewIndexConfigBruteForceConfig] = field(default=None)
    crowding_column: Optional[str] = field(default=None)
    distance_measure_type: Optional[str] = field(default=None)
    embedding_column: Optional[str] = field(default=None)
    embedding_dimension: Optional[int] = field(default=None)
    filter_columns: Optional[List[str]] = field(default=None)
    tree_ah_config: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureView(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_feature_view"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featureOnlineStores", "featureViews"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="featureViews", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "label_fingerprint": S("labelFingerprint"),
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "big_query_source": S("bigQuerySource", default={}) >> Bend(GcpAIPlatformFeatureViewBigQuerySource.mapping),
        "create_time": S("createTime"),
        "etag": S("etag"),
        "feature_registry_source": S("featureRegistrySource", default={}) >> Bend(GcpAIPlatformFeatureViewFeatureRegistrySource.mapping),
        "index_config": S("indexConfig", default={}) >> Bend(GcpAIPlatformFeatureViewIndexConfig.mapping),
        "sync_config": S("syncConfig","cron"),
        "update_time": S("updateTime")
    }
    big_query_source: Optional[GcpAIPlatformFeatureViewBigQuerySource] = field(default=None)
    create_time: Optional[datetime] = field(default=None)
    etag: Optional[str] = field(default=None)
    feature_registry_source: Optional[GcpAIPlatformFeatureViewFeatureRegistrySource] = field(default=None)
    index_config: Optional[GcpAIPlatformFeatureViewIndexConfig] = field(default=None)
    sync_config: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpGoogleTypeInterval:
    kind: ClassVar[str] = "gcp_google_type_interval"
    mapping: ClassVar[Dict[str, Bender]] = {
        "end_time": S("endTime"),
        "start_time": S("startTime")
    }
    ...
    start_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewSyncSyncSummary:
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_sync_sync_summary"
    mapping: ClassVar[Dict[str, Bender]] = {
        "row_synced": S("rowSynced"),
        "total_slot": S("totalSlot")
    }
    row_synced: Optional[str] = field(default=None)
    total_slot: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeatureViewSync(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_feature_view_sync"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featureOnlineStores", "featureViews", "featureViewSyncs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="featureViewSyncs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "create_time": S("createTime"),
        "final_status": S("finalStatus", default={}) >> Bend(GcpGoogleRpcStatus.mapping),
        "run_time": S("runTime", default={}) >> Bend(GcpGoogleTypeInterval.mapping),
        "sync_summary": S("syncSummary", default={}) >> Bend(GcpAIPlatformFeatureViewSyncSyncSummary.mapping)
    }
    create_time: Optional[datetime] = field(default=None)
    final_status: Optional[GcpGoogleRpcStatus] = field(default=None)
    run_time: Optional[GcpGoogleTypeInterval] = field(default=None)
    sync_summary: Optional[GcpAIPlatformFeatureViewSyncSyncSummary] = field(default=None)
@define(eq=False, slots=False)
...
class GcpAIPlatformFeaturestore(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featurestores"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="featurestores", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "encryption_spec": S("encryptionSpec","kmsKeyName"),
        "etag": S("etag"),
        "online_serving_config": S("onlineServingConfig", default={}) >> Bend(GcpAIPlatformFeaturestoreOnlineServingConfig.mapping),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeaturestoreMonitoringConfigImportFeaturesAnalysis:
    kind: ClassVar[str] = "gcp_ai_platform_featurestore_monitoring_config_import_features_analysis"
    mapping: ClassVar[Dict[str, Bender]] = {
        "anomaly_detection_baseline": S("anomalyDetectionBaseline"),
        "state": S("state")
    }
    anomaly_detection_baseline: Optional[str] = field(default=None)
    state: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeaturestoreMonitoringConfigSnapshotAnalysis:
    kind: ClassVar[str] = "gcp_ai_platform_featurestore_monitoring_config_snapshot_analysis"
    mapping: ClassVar[Dict[str, Bender]] = {
        "disabled": S("disabled"),
        "monitoring_interval_days": S("monitoringIntervalDays"),
        "staleness_days": S("stalenessDays")
    }
    disabled: Optional[bool] = field(default=None)
    monitoring_interval_days: Optional[int] = field(default=None)
    staleness_days: Optional[int] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformFeaturestoreMonitoringConfig:
    kind: ClassVar[str] = "gcp_ai_platform_featurestore_monitoring_config"
    mapping: ClassVar[Dict[str, Bender]] = {
        "categorical_threshold_config": S("categoricalThresholdConfig","value"),
        "import_features_analysis": S("importFeaturesAnalysis", default={}) >> Bend(GcpAIPlatformFeaturestoreMonitoringConfigImportFeaturesAnalysis.mapping),
        "numerical_threshold_config": S("numericalThresholdConfig","value"),
        "snapshot_analysis": S("snapshotAnalysis", default={}) >> Bend(GcpAIPlatformFeaturestoreMonitoringConfigSnapshotAnalysis.mapping)
    }
    categorical_threshold_config: Optional[float] = field(default=None)
    import_features_analysis: Optional[GcpAIPlatformFeaturestoreMonitoringConfigImportFeaturesAnalysis] = field(default=None)
    numerical_threshold_config: Optional[float] = field(default=None)
    snapshot_analysis: Optional[GcpAIPlatformFeaturestoreMonitoringConfigSnapshotAnalysis] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformEntityType(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_entity_type"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "featurestores", "entityTypes"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="entityTypes", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "create_time": S("createTime"),
        "etag": S("etag"),
        "monitoring_config": S("monitoringConfig", default={}) >> Bend(GcpAIPlatformFeaturestoreMonitoringConfig.mapping),
        "offline_storage_ttl_days": S("offlineStorageTtlDays"),
        "update_time": S("updateTime")
    }
    create_time: Optional[datetime] = field(default=None)
    etag: Optional[str] = field(default=None)
    monitoring_config: Optional[GcpAIPlatformFeaturestoreMonitoringConfig] = field(default=None)
    offline_storage_ttl_days: Optional[int] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
...
class GcpAIPlatformStudySpecMetricSpec:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "safety_config": S("safetyConfig", default={}) >> Bend(GcpAIPlatformStudySpecMetricSpecSafetyMetricConfig.mapping)
    }
...
class GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecCategoricalValueCondition:
    kind: ClassVar[str] = "gcp_ai_platform_study_spec_parameter_spec_conditional_parameter_spec_categorical_value_condition"
    mapping: ClassVar[Dict[str, Bender]] = {
        "values": S("values", default=[])
    }
    values: Optional[List[str]] = field(default=None)
...
class GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecDiscreteValueCondition:
    kind: ClassVar[str] = "gcp_ai_platform_study_spec_parameter_spec_conditional_parameter_spec_discrete_value_condition"
    mapping: ClassVar[Dict[str, Bender]] = {
        "values": S("values", default=[])
    }
...
class GcpAIPlatformStudySpecParameterSpecConditionalParameterSpec:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "parameter_spec": S("parameterSpec", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpec.mapping),
        "parent_categorical_values": S("parentCategoricalValues", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecCategoricalValueCondition.mapping),
        "parent_discrete_values": S("parentDiscreteValues", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecDiscreteValueCondition.mapping),
        "parent_int_values": S("parentIntValues", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecIntValueCondition.mapping)
    }
    parent_categorical_values: Optional[GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecCategoricalValueCondition] = field(default=None)
    parent_discrete_values: Optional[GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecDiscreteValueCondition] = field(default=None)
    parent_int_values: Optional[GcpAIPlatformStudySpecParameterSpecConditionalParameterSpecIntValueCondition] = field(default=None)
@define(eq=False, slots=False)
...
class GcpAIPlatformStudySpecParameterSpec:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "categorical_value_spec": S("categoricalValueSpec", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecCategoricalValueSpec.mapping),
        "conditional_parameter_specs": S("conditionalParameterSpecs", default=[]) >> ForallBend(GcpAIPlatformStudySpecParameterSpecConditionalParameterSpec.mapping),
        "discrete_value_spec": S("discreteValueSpec", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecDiscreteValueSpec.mapping),
        "double_value_spec": S("doubleValueSpec", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecDoubleValueSpec.mapping),
        "integer_value_spec": S("integerValueSpec", default={}) >> Bend(GcpAIPlatformStudySpecParameterSpecIntegerValueSpec.mapping),
    ...
    conditional_parameter_specs: Optional[List[GcpAIPlatformStudySpecParameterSpecConditionalParameterSpec]] = field(default=None)
...
class GcpAIPlatformStudySpecStudyStoppingConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "maximum_runtime_constraint": S("maximumRuntimeConstraint", default={}) >> Bend(GcpAIPlatformStudyTimeConstraint.mapping),
        "min_num_trials": S("minNumTrials"),
        "minimum_runtime_constraint": S("minimumRuntimeConstraint", default={}) >> Bend(GcpAIPlatformStudyTimeConstraint.mapping),
...
class GcpAIPlatformStudySpec:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "convex_automated_stopping_spec": S("convexAutomatedStoppingSpec", default={}) >> Bend(GcpAIPlatformStudySpecConvexAutomatedStoppingSpec.mapping),
        ...
        "study_stopping_config": S("studyStoppingConfig", default={}) >> Bend(GcpAIPlatformStudySpecStudyStoppingConfig.mapping)
    }
...
class GcpAIPlatformHyperparameterTuningJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "hyperparameterTuningJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="hyperparameterTuningJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformIndexPrivateEndpoints:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "psc_automated_endpoints": S("pscAutomatedEndpoints", default=[]) >> ForallBend(GcpAIPlatformPscAutomatedEndpoints.mapping),
        "service_attachment": S("serviceAttachment")
    }
...
class GcpAIPlatformDeployedIndex:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "create_time": S("createTime"),
        "dedicated_resources": S("dedicatedResources", default={}) >> Bend(GcpAIPlatformDedicatedResources.mapping),
        "deployed_index_auth_config": S("deployedIndexAuthConfig", default={}) >> Bend(GcpAIPlatformDeployedIndexAuthConfig.mapping),
...
class GcpAIPlatformIndexEndpoint(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "indexEndpoints"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="indexEndpoints", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformIndex(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "indexes"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="indexes", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformMetadataStore(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_metadata_store"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "metadataStores"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="metadataStores", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "create_time": S("createTime"),
        "dataplex_config": S("dataplexConfig","enabledPipelinesLineage"),
        "encryption_spec": S("encryptionSpec","kmsKeyName"),
        "state": S("state","diskUtilizationBytes"),
        "update_time": S("updateTime")
    }
    create_time: Optional[datetime] = field(default=None)
    dataplex_config: Optional[bool] = field(default=None)
    encryption_spec: Optional[str] = field(default=None)
    state: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformArtifact(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_artifact"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "metadataStores", "artifacts"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="artifacts", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    uri: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformContext(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_context"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "metadataStores", "contexts"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="contexts", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformExecution(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_execution"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "metadataStores", "executions"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="executions", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
    ...
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformMetadataSchema(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_metadata_schema"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "metadataStores", "metadataSchemas"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="metadataSchemas", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformSamplingStrategy:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "random_sample_config": S("randomSampleConfig","sampleRate")
    }
...
class GcpAIPlatformModelMonitoringObjectiveConfigExplanationConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "explanation_baseline": S("explanationBaseline", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfigExplanationConfigExplanationBaseline.mapping)
    }
    enable_feature_attributes: Optional[bool] = field(default=None)
    explanation_baseline: Optional[GcpAIPlatformModelMonitoringObjectiveConfigExplanationConfigExplanationBaseline] = field(default=None)
@define(eq=False, slots=False)
...
class GcpAIPlatformModelMonitoringObjectiveConfigPredictionDriftDetectionConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "attribution_score_drift_thresholds": S("attributionScoreDriftThresholds", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformThresholdConfig.mapping)),
        "default_drift_threshold": S("defaultDriftThreshold","value"),
        "drift_thresholds": S("driftThresholds", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformThresholdConfig.mapping))
    }
...
class GcpAIPlatformModelMonitoringObjectiveConfigTrainingDataset:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "dataset": S("dataset"),
        "gcs_source": S("gcsSource", default={}) >> Bend(GcpAIPlatformGcsSource.mapping),
        "logging_sampling_strategy": S("loggingSamplingStrategy", default={}) >> Bend(GcpAIPlatformSamplingStrategy.mapping),
...
class GcpAIPlatformModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "attribution_score_skew_thresholds": S("attributionScoreSkewThresholds", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformThresholdConfig.mapping)),
        "default_skew_threshold": S("defaultSkewThreshold","value"),
        "skew_thresholds": S("skewThresholds", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformThresholdConfig.mapping))
    }
...
class GcpAIPlatformModelMonitoringObjectiveConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "explanation_config": S("explanationConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfigExplanationConfig.mapping),
        "prediction_drift_detection_config": S("predictionDriftDetectionConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfigPredictionDriftDetectionConfig.mapping),
        "training_dataset": S("trainingDataset", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfigTrainingDataset.mapping),
        "training_prediction_skew_detection_config": S("trainingPredictionSkewDetectionConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig.mapping)
    }
    explanation_config: Optional[GcpAIPlatformModelMonitoringObjectiveConfigExplanationConfig] = field(default=None)
    prediction_drift_detection_config: Optional[GcpAIPlatformModelMonitoringObjectiveConfigPredictionDriftDetectionConfig] = field(default=None)
    training_dataset: Optional[GcpAIPlatformModelMonitoringObjectiveConfigTrainingDataset] = field(default=None)
    training_prediction_skew_detection_config: Optional[GcpAIPlatformModelMonitoringObjectiveConfigTrainingPredictionSkewDetectionConfig] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformModelDeploymentMonitoringObjectiveConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "objective_config": S("objectiveConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringObjectiveConfig.mapping)
    }
...
class GcpAIPlatformModelMonitoringAlertConfigEmailAlertConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "user_emails": S("userEmails", default=[])
    }
...
class GcpAIPlatformModelMonitoringAlertConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "email_alert_config": S("emailAlertConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringAlertConfigEmailAlertConfig.mapping),
...
class GcpAIPlatformModelDeploymentMonitoringJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "modelDeploymentMonitoringJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="modelDeploymentMonitoringJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "bigquery_tables": S("bigqueryTables", default=[]) >> ForallBend(GcpAIPlatformModelDeploymentMonitoringBigQueryTable.mapping),
        "create_time": S("createTime"),
        "display_name": S("displayName"),
        ...
        "endpoint": S("endpoint"),
        "error": S("error", default={}) >> Bend(GcpGoogleRpcStatus.mapping),
        "latest_monitoring_pipeline_metadata": S("latestMonitoringPipelineMetadata", default={}) >> Bend(GcpAIPlatformModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata.mapping),
        "log_ttl": S("logTtl"),
        "logging_sampling_strategy": S("loggingSamplingStrategy", default={}) >> Bend(GcpAIPlatformSamplingStrategy.mapping),
        "model_deployment_monitoring_objective_configs": S("modelDeploymentMonitoringObjectiveConfigs", default=[]) >> ForallBend(GcpAIPlatformModelDeploymentMonitoringObjectiveConfig.mapping),
        "model_deployment_monitoring_schedule_config": S("modelDeploymentMonitoringScheduleConfig", default={}) >> Bend(GcpAIPlatformModelDeploymentMonitoringScheduleConfig.mapping),
        "model_monitoring_alert_config": S("modelMonitoringAlertConfig", default={}) >> Bend(GcpAIPlatformModelMonitoringAlertConfig.mapping),
    ...
    error: Optional[GcpGoogleRpcStatus] = field(default=None)
    latest_monitoring_pipeline_metadata: Optional[GcpAIPlatformModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata] = field(default=None)
    log_ttl: Optional[str] = field(default=None)
    logging_sampling_strategy: Optional[GcpAIPlatformSamplingStrategy] = field(default=None)
    model_deployment_monitoring_objective_configs: Optional[List[GcpAIPlatformModelDeploymentMonitoringObjectiveConfig]] = field(default=None)
    model_deployment_monitoring_schedule_config: Optional[GcpAIPlatformModelDeploymentMonitoringScheduleConfig] = field(default=None)
...
class GcpAIPlatformModelExportFormat:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "exportable_contents": S("exportableContents", default=[]),
        "id": S("id")
    }
...
class GcpAIPlatformModel(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "models"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="models", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "supported_export_formats": S("supportedExportFormats", default=[]) >> ForallBend(GcpAIPlatformModelExportFormat.mapping),
...
class GcpAIPlatformModelEvaluation(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "models", "evaluations"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="modelEvaluations", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "display_name": S("displayName"),
        "explanation_specs": S("explanationSpecs", default=[]) >> ForallBend(GcpAIPlatformModelEvaluationModelEvaluationExplanationSpec.mapping),
        "metadata": S("metadata"),
        "metrics": S("metrics"),
...
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSliceSliceSliceSpecRange:
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice_slice_slice_spec_range"
    mapping: ClassVar[Dict[str, Bender]] = {
        "high": S("high"),
        "low": S("low")
    }
...
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSliceSliceSliceSpecValue:
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice_slice_slice_spec_value"
    mapping: ClassVar[Dict[str, Bender]] = {
...
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSliceSliceSliceSpecSliceConfig:
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice_slice_slice_spec_slice_config"
    mapping: ClassVar[Dict[str, Bender]] = {
        "all_values": S("allValues"),
        "range": S("range", default={}) >> Bend(GcpAIPlatformModelEvaluationSliceSliceSliceSpecRange.mapping),
        "value": S("value", default={}) >> Bend(GcpAIPlatformModelEvaluationSliceSliceSliceSpecValue.mapping)
    }
    all_values: Optional[bool] = field(default=None)
    range: Optional[GcpAIPlatformModelEvaluationSliceSliceSliceSpecRange] = field(default=None)
    value: Optional[GcpAIPlatformModelEvaluationSliceSliceSliceSpecValue] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSliceSliceSliceSpec:
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice_slice_slice_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "configs": S("configs", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformModelEvaluationSliceSliceSliceSpecSliceConfig.mapping))
    }
    configs: Optional[Dict[str, GcpAIPlatformModelEvaluationSliceSliceSliceSpecSliceConfig]] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSliceSlice:
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice_slice"
    mapping: ClassVar[Dict[str, Bender]] = {
        "dimension": S("dimension"),
        "slice_spec": S("sliceSpec", default={}) >> Bend(GcpAIPlatformModelEvaluationSliceSliceSliceSpec.mapping),
        "value": S("value")
    }
    dimension: Optional[str] = field(default=None)
    slice_spec: Optional[GcpAIPlatformModelEvaluationSliceSliceSliceSpec] = field(default=None)
    value: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformModelEvaluationSlice(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_model_evaluation_slice"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "models", "evaluations", "slices"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="modelEvaluationSlices", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "metrics_schema_uri": S("metricsSchemaUri"),
        "model_explanation": S("modelExplanation", default={}) >> Bend(GcpAIPlatformModelExplanation.mapping),
        "slice": S("slice", default={}) >> Bend(GcpAIPlatformModelEvaluationSliceSlice.mapping)
    }
    create_time: Optional[datetime] = field(default=None)
    metrics: Optional[Any] = field(default=None)
    metrics_schema_uri: Optional[str] = field(default=None)
    model_explanation: Optional[GcpAIPlatformModelExplanation] = field(default=None)
    slice: Optional[GcpAIPlatformModelEvaluationSliceSlice] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasTrial:
    kind: ClassVar[str] = "gcp_ai_platform_nas_trial"
    mapping: ClassVar[Dict[str, Bender]] = {
        "end_time": S("endTime"),
        "final_measurement": S("finalMeasurement", default={}) >> Bend(GcpAIPlatformMeasurement.mapping),
        "id": S("id"),
    ...
    state: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobOutputMultiTrialJobOutput:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_output_multi_trial_job_output"
    mapping: ClassVar[Dict[str, Bender]] = {
        "search_trials": S("searchTrials", default=[]) >> ForallBend(GcpAIPlatformNasTrial.mapping),
        "train_trials": S("trainTrials", default=[]) >> ForallBend(GcpAIPlatformNasTrial.mapping)
    }
    search_trials: Optional[List[GcpAIPlatformNasTrial]] = field(default=None)
    train_trials: Optional[List[GcpAIPlatformNasTrial]] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobOutput:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_output"
    mapping: ClassVar[Dict[str, Bender]] = {
        "multi_trial_job_output": S("multiTrialJobOutput", default={}) >> Bend(GcpAIPlatformNasJobOutputMultiTrialJobOutput.mapping)
    }
    multi_trial_job_output: Optional[GcpAIPlatformNasJobOutputMultiTrialJobOutput] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecMetricSpec:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_spec_multi_trial_algorithm_spec_metric_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "goal": S("goal"),
        "metric_id": S("metricId")
    }
    ...
    metric_id: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_spec_multi_trial_algorithm_spec_search_trial_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "max_failed_trial_count": S("maxFailedTrialCount"),
        "max_parallel_trial_count": S("maxParallelTrialCount"),
        "max_trial_count": S("maxTrialCount"),
        "search_trial_job_spec": S("searchTrialJobSpec", default={}) >> Bend(GcpAIPlatformCustomJobSpec.mapping)
    }
    max_failed_trial_count: Optional[int] = field(default=None)
    max_parallel_trial_count: Optional[int] = field(default=None)
    max_trial_count: Optional[int] = field(default=None)
    search_trial_job_spec: Optional[GcpAIPlatformCustomJobSpec] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_spec_multi_trial_algorithm_spec_train_trial_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "frequency": S("frequency"),
        "max_parallel_trial_count": S("maxParallelTrialCount"),
        "train_trial_job_spec": S("trainTrialJobSpec", default={}) >> Bend(GcpAIPlatformCustomJobSpec.mapping)
    }
    frequency: Optional[int] = field(default=None)
    max_parallel_trial_count: Optional[int] = field(default=None)
    train_trial_job_spec: Optional[GcpAIPlatformCustomJobSpec] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpec:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_spec_multi_trial_algorithm_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "metric": S("metric", default={}) >> Bend(GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecMetricSpec.mapping),
        "multi_trial_algorithm": S("multiTrialAlgorithm"),
        "search_trial_spec": S("searchTrialSpec", default={}) >> Bend(GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec.mapping),
        "train_trial_spec": S("trainTrialSpec", default={}) >> Bend(GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec.mapping)
    }
    metric: Optional[GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecMetricSpec] = field(default=None)
    multi_trial_algorithm: Optional[str] = field(default=None)
    search_trial_spec: Optional[GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecSearchTrialSpec] = field(default=None)
    train_trial_spec: Optional[GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpecTrainTrialSpec] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJobSpec:
    kind: ClassVar[str] = "gcp_ai_platform_nas_job_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "multi_trial_algorithm_spec": S("multiTrialAlgorithmSpec", default={}) >> Bend(GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpec.mapping),
        "resume_nas_job_id": S("resumeNasJobId"),
        "search_space_spec": S("searchSpaceSpec")
    }
    multi_trial_algorithm_spec: Optional[GcpAIPlatformNasJobSpecMultiTrialAlgorithmSpec] = field(default=None)
    resume_nas_job_id: Optional[str] = field(default=None)
    search_space_spec: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasJob(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_nas_job"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "nasJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="nasJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "create_time": S("createTime"),
        "display_name": S("displayName"),
        "enable_restricted_image_training": S("enableRestrictedImageTraining"),
        "encryption_spec": S("encryptionSpec","kmsKeyName"),
        "end_time": S("endTime"),
        "error": S("error", default={}) >> Bend(GcpGoogleRpcStatus.mapping),
        "nas_job_output": S("nasJobOutput", default={}) >> Bend(GcpAIPlatformNasJobOutput.mapping),
        "nas_job_spec": S("nasJobSpec", default={}) >> Bend(GcpAIPlatformNasJobSpec.mapping),
        "start_time": S("startTime"),
        "state": S("state"),
        "update_time": S("updateTime")
    }
    create_time: Optional[datetime] = field(default=None)
    display_name: Optional[str] = field(default=None)
    enable_restricted_image_training: Optional[bool] = field(default=None)
    encryption_spec: Optional[str] = field(default=None)
    end_time: Optional[datetime] = field(default=None)
    error: Optional[GcpGoogleRpcStatus] = field(default=None)
    nas_job_output: Optional[GcpAIPlatformNasJobOutput] = field(default=None)
    nas_job_spec: Optional[GcpAIPlatformNasJobSpec] = field(default=None)
    start_time: Optional[datetime] = field(default=None)
    state: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNasTrialDetail(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_nas_trial_detail"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "nasJobs", "nasTrialDetails"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="nasTrialDetails", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "search_trial": S("searchTrial", default={}) >> Bend(GcpAIPlatformNasTrial.mapping),
        "train_trial": S("trainTrial", default={}) >> Bend(GcpAIPlatformNasTrial.mapping)
    }
    parameters: Optional[str] = field(default=None)
    search_trial: Optional[GcpAIPlatformNasTrial] = field(default=None)
    train_trial: Optional[GcpAIPlatformNasTrial] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformPersistentDiskSpec:
    kind: ClassVar[str] = "gcp_ai_platform_persistent_disk_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
...
@define(eq=False, slots=False)
class GcpAIPlatformNotebookEucConfig:
    kind: ClassVar[str] = "gcp_ai_platform_notebook_euc_config"
    mapping: ClassVar[Dict[str, Bender]] = {
        "bypass_actas_check": S("bypassActasCheck"),
        "euc_disabled": S("eucDisabled")
    }
    bypass_actas_check: Optional[bool] = field(default=None)
    euc_disabled: Optional[bool] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNotebookIdleShutdownConfig:
    kind: ClassVar[str] = "gcp_ai_platform_notebook_idle_shutdown_config"
    mapping: ClassVar[Dict[str, Bender]] = {
        "idle_shutdown_disabled": S("idleShutdownDisabled"),
        "idle_timeout": S("idleTimeout")
    }
    idle_shutdown_disabled: Optional[bool] = field(default=None)
    idle_timeout: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNetworkSpec:
    kind: ClassVar[str] = "gcp_ai_platform_network_spec"
    mapping: ClassVar[Dict[str, Bender]] = {
        "enable_internet_access": S("enableInternetAccess"),
        "network": S("network"),
        "subnetwork": S("subnetwork")
    }
    enable_internet_access: Optional[bool] = field(default=None)
    network: Optional[str] = field(default=None)
    subnetwork: Optional[str] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNotebookRuntimeTemplate(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_notebook_runtime_template"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "notebookRuntimeTemplates"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="notebookRuntimeTemplates", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "deprecation_status": S("deprecated", default={}) >> Bend(GcpDeprecationStatus.mapping),
        "create_time": S("createTime"),
        "data_persistent_disk_spec": S("dataPersistentDiskSpec", default={}) >> Bend(GcpAIPlatformPersistentDiskSpec.mapping),
        "display_name": S("displayName"),
        "encryption_spec": S("encryptionSpec","kmsKeyName"),
        "etag": S("etag"),
        "euc_config": S("eucConfig", default={}) >> Bend(GcpAIPlatformNotebookEucConfig.mapping),
        "idle_shutdown_config": S("idleShutdownConfig", default={}) >> Bend(GcpAIPlatformNotebookIdleShutdownConfig.mapping),
        "is_default": S("isDefault"),
        "machine_spec": S("machineSpec", default={}) >> Bend(GcpAIPlatformMachineSpec.mapping),
        "network_spec": S("networkSpec", default={}) >> Bend(GcpAIPlatformNetworkSpec.mapping),
        "network_tags": S("networkTags", default=[]),
        "notebook_runtime_type": S("notebookRuntimeType"),
        "service_account": S("serviceAccount"),
        "shielded_vm_config": S("shieldedVmConfig","enableSecureBoot"),
        "update_time": S("updateTime")
    }
    create_time: Optional[datetime] = field(default=None)
    data_persistent_disk_spec: Optional[GcpAIPlatformPersistentDiskSpec] = field(default=None)
    display_name: Optional[str] = field(default=None)
    encryption_spec: Optional[str] = field(default=None)
    etag: Optional[str] = field(default=None)
    euc_config: Optional[GcpAIPlatformNotebookEucConfig] = field(default=None)
    idle_shutdown_config: Optional[GcpAIPlatformNotebookIdleShutdownConfig] = field(default=None)
    is_default: Optional[bool] = field(default=None)
    machine_spec: Optional[GcpAIPlatformMachineSpec] = field(default=None)
    network_spec: Optional[GcpAIPlatformNetworkSpec] = field(default=None)
    network_tags: Optional[List[str]] = field(default=None)
    notebook_runtime_type: Optional[str] = field(default=None)
    service_account: Optional[str] = field(default=None)
    shielded_vm_config: Optional[bool] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
@define(eq=False, slots=False)
class GcpAIPlatformNotebookRuntime(GcpResource):
    kind: ClassVar[str] = "gcp_ai_platform_notebook_runtime"
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "notebookRuntimes"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="notebookRuntimes", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "idle_shutdown_config": S("idleShutdownConfig", default={}) >> Bend(GcpAIPlatformNotebookIdleShutdownConfig.mapping),
        "is_upgradable": S("isUpgradable"),
        "network_tags": S("networkTags", default=[]),
        "notebook_runtime_template_ref": S("notebookRuntimeTemplateRef","notebookRuntimeTemplate"),
        "notebook_runtime_type": S("notebookRuntimeType"),
        "proxy_uri": S("proxyUri"),
        "runtime_state": S("runtimeState"),
        "runtime_user": S("runtimeUser"),
        "satisfies_pzi": S("satisfiesPzi"),
        "satisfies_pzs": S("satisfiesPzs"),
        "service_account": S("serviceAccount"),
        "update_time": S("updateTime"),
    ...
    health_state: Optional[str] = field(default=None)
    idle_shutdown_config: Optional[GcpAIPlatformNotebookIdleShutdownConfig] = field(default=None)
    is_upgradable: Optional[bool] = field(default=None)
    network_tags: Optional[List[str]] = field(default=None)
    notebook_runtime_template_ref: Optional[str] = field(default=None)
    notebook_runtime_type: Optional[str] = field(default=None)
    proxy_uri: Optional[str] = field(default=None)
    runtime_state: Optional[str] = field(default=None)
    runtime_user: Optional[str] = field(default=None)
    satisfies_pzi: Optional[bool] = field(default=None)
    satisfies_pzs: Optional[bool] = field(default=None)
    service_account: Optional[str] = field(default=None)
    update_time: Optional[datetime] = field(default=None)
...
class GcpAIPlatformPipelineTaskExecutorDetailCustomJobDetail:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "failed_jobs": S("failedJobs", default=[]),
        "job": S("job")
    }
...
class GcpAIPlatformPipelineTaskExecutorDetail:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "container_detail": S("containerDetail", default={}) >> Bend(GcpAIPlatformPipelineTaskExecutorDetailContainerDetail.mapping),
        "custom_job_detail": S("customJobDetail", default={}) >> Bend(GcpAIPlatformPipelineTaskExecutorDetailCustomJobDetail.mapping)
    }
...
class GcpAIPlatformPipelineTaskDetail:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "inputs": S("inputs", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformPipelineTaskDetailArtifactList.mapping)),
        "outputs": S("outputs", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformPipelineTaskDetailArtifactList.mapping)),
        "parent_task_id": S("parentTaskId"),
        "pipeline_task_status": S("pipelineTaskStatus", default=[]) >> ForallBend(GcpAIPlatformPipelineTaskDetailPipelineTaskStatus.mapping),
        "start_time": S("startTime"),
        "state": S("state"),
        "task_id": S("taskId"),
...
class GcpAIPlatformPipelineJobRuntimeConfig:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "gcs_output_directory": S("gcsOutputDirectory"),
        "input_artifacts": S("inputArtifacts", default={}) >> MapDict(value_bender=Bend(GcpAIPlatformPipelineJobRuntimeConfigInputArtifact.mapping)),
...
class GcpAIPlatformPipelineJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "pipelineJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="pipelineJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformSchedule(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "schedules"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="schedules", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "catch_up": S("catchUp"),
        "create_pipeline_job_request": S("createPipelineJobRequest", default={}) >> Bend(GcpAIPlatformCreatePipelineJobRequest.mapping),
        "create_time": S("createTime"),
        "cron": S("cron"),
        "display_name": S("displayName"),
        "end_time": S("endTime"),
        ...
        "last_scheduled_run_response": S("lastScheduledRunResponse", default={}) >> Bend(GcpAIPlatformScheduleRunResponse.mapping),
...
class GcpAIPlatformTensorboard(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "tensorboards"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="tensorboards", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformTrainingPipeline(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "trainingPipelines"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="trainingPipelines", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
...
class GcpAIPlatformFunctionCall:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "args": S("args", default={}) >> Bend(GcpArgs.mapping),
        "name": S("name")
    }
...
class GcpAIPlatformFunctionResponse:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "name": S("name"),
        "response": S("response", default={}) >> Bend(GcpResponse.mapping)
    }
    name: Optional[str] = field(default=None)
    response: Optional[GcpResponse] = field(default=None)
@define(eq=False, slots=False)
...
class GcpAIPlatformSupervisedTuningDatasetDistribution:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "buckets": S("buckets", default=[]) >> ForallBend(GcpAIPlatformSupervisedTuningDatasetDistributionDatasetBucket.mapping),
        "max": S("max"),
        "mean": S("mean"),
        "median": S("median"),
        "min": S("min"),
...
class GcpAIPlatformSupervisedTuningDataStats:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        ...
        "user_input_token_distribution": S("userInputTokenDistribution", default={}) >> Bend(GcpAIPlatformSupervisedTuningDatasetDistribution.mapping),
        "user_message_per_example_distribution": S("userMessagePerExampleDistribution", default={}) >> Bend(GcpAIPlatformSupervisedTuningDatasetDistribution.mapping),
        "user_output_token_distribution": S("userOutputTokenDistribution", default={}) >> Bend(GcpAIPlatformSupervisedTuningDatasetDistribution.mapping)
    }
    ...
    user_message_per_example_distribution: Optional[GcpAIPlatformSupervisedTuningDatasetDistribution] = field(default=None)
...
class GcpAIPlatformTuningDataStats:
    ...
    mapping: ClassVar[Dict[str, Bender]] = {
        "supervised_tuning_data_stats": S("supervisedTuningDataStats", default={}) >> Bend(GcpAIPlatformSupervisedTuningDataStats.mapping)
    }
...
class GcpAIPlatformTuningJob(GcpResource):
    ...
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(service="aiplatform", version="v1", accessors=["projects", "locations", "tuningJobs"], action="list", request_parameter={'parent': 'projects/{project}/locations/{region}/-'}, request_parameter_in={"project", "region"}, response_path="tuningJobs", response_regional_sub_path=None)
    mapping: ClassVar[Dict[str, Bender]] = {
        "id": S("name").or_else(S("id")).or_else(S("selfLink")),
        "tags": S("labels", default={}),
        "name": S("name"),
        ...
        "start_time": S("startTime"),
        "state": S("state"),
        "supervised_tuning_spec": S("supervisedTuningSpec", default={}) >> Bend(GcpAIPlatformSupervisedTuningSpec.mapping),
