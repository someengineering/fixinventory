...
class GcpSqlOperationError:
    ...
    kind_description: ClassVar[str] = "This error refers to an error that occurred during an operation related to Google Cloud SQL, which is a fully managed relational database service provided by Google Cloud Platform."
...
class GcpSqlBackupRun(GcpResource):
    ...
    kind_description: ClassVar[str] = "GCP SQL Backup Run is a feature in Google Cloud Platform that allows users to schedule and execute automated backups of their SQL databases."
...
class GcpSqlSqlServerDatabaseDetails:
    ...
    kind_description: ClassVar[str] = "This resource provides details and information about a Microsoft SQL Server database in the Google Cloud Platform's SQL service."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlDatabase(GcpResource):
    ...
    kind_description: ClassVar[str] = "GCP SQL Database is a managed relational database service provided by Google Cloud Platform."
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(
        service="sqladmin",
        version="v1",
        accessors=["databases"],
...
class GcpSqlFailoverreplica:
    ...
    kind_description: ClassVar[str] = "A GCP SQL Failover Replica is a secondary replica database that can be promoted to the primary database in case of a primary database failure, ensuring high availability and data redundancy for Google Cloud SQL."
...
class GcpSqlIpMapping:
    ...
    kind_description: ClassVar[str] = "GCP SQL IP Mapping is a feature in Google Cloud Platform that allows mapping of IP addresses to Google Cloud SQL instances."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlInstanceReference:
    ...
    kind_description: ClassVar[str] = "Cloud SQL is a fully-managed relational database service provided by Google Cloud Platform, allowing users to create and manage MySQL or PostgreSQL databases in the cloud."
...
class GcpSqlOnPremisesConfiguration:
    ...
    kind_description: ClassVar[str] = "GCP SQL On-Premises Configuration provides the ability to configure and manage Google Cloud SQL databases that are located on customer's own on-premises infrastructure."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlSqlOutOfDiskReport:
    ...
    kind_description: ClassVar[str] = "This resource represents a report that indicates when a Google Cloud SQL instance runs out of disk space."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlMySqlReplicaConfiguration:
    ...
    kind_description: ClassVar[str] = "MySQL Replica Configuration is a feature in Google Cloud SQL that enables the creation and management of replicas for high availability and fault tolerance of MySQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
        "ca_certificate": S("caCertificate"),
        "client_certificate": S("clientCertificate"),
        "client_key": S("clientKey"),
...
class GcpSqlReplicaConfiguration:
    ...
    kind_description: ClassVar[str] = "SQL replica configuration in Google Cloud Platform (GCP) allows users to create and manage replica instances of a SQL database for improved scalability and high availability."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlSqlScheduledMaintenance:
    ...
    kind_description: ClassVar[str] = "SQL Scheduled Maintenance is a feature in Google Cloud Platform's SQL service that allows users to schedule maintenance tasks for their SQL instances, ensuring minimal downtime and disruption."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlSslCert:
    ...
    kind_description: ClassVar[str] = "GCP SQL SSL Certificates are used to secure connections between applications and Google Cloud SQL databases, ensuring that data exchanged between them is encrypted."
    mapping: ClassVar[Dict[str, Bender]] = {
        "cert": S("cert"),
...
class GcpSqlBackupRetentionSettings:
    ...
    kind_description: ClassVar[str] = "GCP SQL Backup Retention Settings is a feature in Google Cloud Platform that allows you to configure the backup retention policy for your SQL databases. It lets you set the duration for which backups should be retained before being automatically deleted."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlBackupConfiguration:
    ...
    kind_description: ClassVar[str] = "GCP SQL Backup Configuration is a resource in Google Cloud Platform that allows users to configure and manage backups for their SQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlDatabaseFlags:
    ...
    kind_description: ClassVar[str] = "GCP SQL Database Flags are configuration settings that can be applied to Google Cloud Platform's SQL databases to customize their behavior."
...
class GcpSqlDenyMaintenancePeriod:
    ...
    kind_description: ClassVar[str] = "GCP SQL Deny Maintenance Period is a feature in Google Cloud Platform that allows users to specify a period of time during which maintenance updates or patches will not be applied to SQL instances."
...
class GcpSqlInsightsConfig:
    ...
    kind_description: ClassVar[str] = "GCP SQL Insights Config is a feature in Google Cloud Platform that allows users to configure and customize their SQL database insights and monitoring."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlAclEntry:
    ...
    kind_description: ClassVar[str] = "GCP SQL ACL Entry is a resource in Google Cloud Platform that represents an access control list entry for a Cloud SQL instance. It defines policies for granting or denying network access to the SQL instance."
    mapping: ClassVar[Dict[str, Bender]] = {
        "expiration_time": S("expirationTime"),
        "name": S("name"),
        "value": S("value"),
...
class GcpSqlIpConfiguration:
    ...
    kind_description: ClassVar[str] = "IP Configuration refers to the settings for managing IP addresses associated with Google Cloud Platform(SQL) instances, allowing users to control network access to their databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlLocationPreference:
    ...
    kind_description: ClassVar[str] = "GCP SQL Location Preference allows users to specify the preferred location for their Google Cloud SQL database instances, helping them ensure optimal performance and compliance with data sovereignty requirements."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlMaintenanceWindow:
    ...
    kind_description: ClassVar[str] = "A maintenance window is a predefined time period when Google Cloud SQL performs system updates and maintenance tasks on your databases."
...
class GcpSqlPasswordValidationPolicy:
    ...
    kind_description: ClassVar[str] = "GCP SQL Password Validation Policy is a feature in Google Cloud Platform that enforces strong password policies for SQL databases, ensuring better security and compliance with password requirements."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlSqlServerAuditConfig:
    ...
    kind_description: ClassVar[str] = "GCP SQL Server Audit Configuration provides a way to enable and configure SQL Server auditing for Google Cloud Platform (GCP) SQL Server instances. Auditing allows users to monitor and record database activities and events for security and compliance purposes."
    mapping: ClassVar[Dict[str, Bender]] = {
        "bucket": S("bucket"),
...
class GcpSqlSettings:
    ...
    kind_description: ClassVar[str] = "GCP SQL Settings refers to the configuration and customization options for managing SQL databases in Google Cloud Platform (GCP). It includes various settings related to database performance, security, availability, and monitoring."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlDatabaseInstance(GcpResource):
    ...
    kind_description: ClassVar[str] = "GCP SQL Database Instance is a resource provided by Google Cloud Platform that allows users to create and manage relational databases in the cloud."
...
class GcpSqlCsvexportoptions:
    ...
    kind_description: ClassVar[str] = "CSV Export Options for Google Cloud Platform's SQL allows users to export SQL query results into CSV format for further analysis or data manipulation."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlMysqlexportoptions:
    ...
    kind_description: ClassVar[str] = "GCP SQL MySQL Export Options are features provided by Google Cloud Platform that allow users to export data from MySQL databases hosted on GCP SQL."
...
class GcpSqlSqlexportoptions:
    ...
    kind_description: ClassVar[str] = "SQLExportOptions is a feature in Google Cloud Platform's SQL service that allows users to export their SQL databases to different formats, such as CSV or JSON."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlExportContext:
    ...
    kind_description: ClassVar[str] = "GCP SQL Export Context is a feature in Google Cloud Platform that allows users to export data from SQL databases to other storage or analysis services."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlEncryptionoptions:
    ...
    kind_description: ClassVar[str] = "GCP SQL Encryption Options refers to the various methods available for encrypting data in Google Cloud Platform's SQL databases, such as Cloud SQL and SQL Server on GCE."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlBakimportoptions:
    ...
    kind_description: ClassVar[str] = "GCP SQL Backup Import Options provide configuration settings and options for importing backed up data into Google Cloud Platform SQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlCsvimportoptions:
    ...
    kind_description: ClassVar[str] = "CSV Import Options in GCP SQL enables users to efficiently import CSV data into Google Cloud SQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlImportContext:
    ...
    kind_description: ClassVar[str] = "SQL Import Context is a feature provided by Google Cloud Platform to provide contextual information while importing SQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlOperation(GcpResource):
    ...
    kind_description: ClassVar[str] = "SQL Operation is a service in Google Cloud Platform (GCP) that provides fully managed and highly available relational databases."
    reference_kinds: ClassVar[ModelReference] = {"predecessors": {"default": ["gcp_sql_database_instance"]}}
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(
        service="sqladmin",
        version="v1",
...
class GcpSqlPasswordStatus:
    ...
    kind_description: ClassVar[str] = "GCP SQL Password Status refers to the current state of the password used for SQL database access in Google Cloud Platform. It indicates whether the password is active or inactive."
    mapping: ClassVar[Dict[str, Bender]] = {
        "locked": S("locked"),
...
class GcpSqlUserPasswordValidationPolicy:
    ...
    kind_description: ClassVar[str] = "GCP SQL User Password Validation Policy is a feature in Google Cloud Platform's SQL service that enforces specific rules and requirements for creating and managing user passwords in SQL databases."
    mapping: ClassVar[Dict[str, Bender]] = {
...
class GcpSqlSqlServerUserDetails:
    ...
    kind_description: ClassVar[str] = "GCP SQL SQL Server User Details provides information about the users and their access privileges in a SQL Server instance on Google Cloud Platform."
...
class GcpSqlUser(GcpResource):
    ...
    kind_description: ClassVar[str] = "A GCP SQL User refers to a user account that can access and manage databases in Google Cloud SQL, a fully-managed relational database service."
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(
        service="sqladmin",
        version="v1",
        accessors=["users"],
