...
class GcpSqlDatabase(GcpResource):
    ...
    kind_description: ClassVar[str] = (
        "GCP SQL Database is a managed relational database service provided by Google"
        " Cloud Platform."
    )
    api_spec: ClassVar[GcpApiSpec] = GcpApiSpec(
        service="sqladmin",
...
class GcpSqlSqlOutOfDiskReport:
    ...
    kind_description: ClassVar[str] = (
        "This resource represents a report that indicates when a Google Cloud SQL"
...
class GcpSqlCsvimportoptions:
    ...
    kind_description: ClassVar[str] = (
        "CSV Import Options in GCP SQL enables users to efficiently import CSV data"
        " into Google Cloud SQL databases."
    )
    mapping: ClassVar[Dict[str, Bender]] = {
